...
typedef struct stru_255ElemStruct {
	char elem1[255];
} stru_255ElemStruct;

typedef struct stru_4081_Bytes {
	char elem[4081];
} stru_4081_Bytes;

typedef struct stru_4080_Bytes {
	char elem[4080];
} stru_4080_Bytes;

typedef struct stru_4079_Bytes {
	char elem[4079];
} stru_4079_Bytes;

typedef struct stru_256_Bytes {
	char elem[256];
} stru_256_Bytes;

typedef struct stru_255_Bytes {
	char elem[255];
} stru_255_Bytes;

typedef struct stru_254ElemStruct {
	char elem1[254];
} stru_254ElemStruct;
...
typedef struct stru_1ElementStruct {
	char elem[1];
} stru_1ElementStruct;
typedef struct stru_2ElementStruct {
	char elem[2];
} stru_2ElementStruct;
typedef struct stru_3ElementStruct {
	char elem[3];
} stru_3ElementStruct;
typedef struct stru_4ElementStruct {
	char elem[4];
} stru_4ElementStruct;
typedef struct stru_7ElementStruct {
	char elem[7];
} stru_7ElementStruct;
typedef struct stru_8ElementStruct {
	char elem[8];
} stru_8ElementStruct;
